...
print(f"El primero en llegar a {limite_puntos} puntos gana.\n")

#Bucle principal del juego
while puntos_jugador < limite_puntos and puntos_rival < limite_puntos:

    print(f"--- Ronda {ronda} ---")
    print(f"Marcador | Jugador: {puntos_jugador}  -  Rival: {puntos_rival}")
    ...
    if bloqueo_jugador == "s":
        ...
        if bloqueo_rival == "n":
            ...
            print(f"¡Punto para el jugador! ({puntos_jugador} pts)\n")
        else:
